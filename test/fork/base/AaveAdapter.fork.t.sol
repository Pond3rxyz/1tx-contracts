...
/// @notice Fork tests for AaveAdapter against Base mainnet
contract AaveAdapterForkTest is AdapterForkTestBase {
    ...
    function test_fork_aave_usdc_deposit() public {
        _testDeposit("USDC", DEPOSIT_AMOUNT);
    }

    function test_fork_aave_usdc_depositWithdraw() public {
        _testDepositWithdraw("USDC", DEPOSIT_AMOUNT);
    }

    function test_fork_aave_usdt_deposit() public {
        _testDeposit("USDT", DEPOSIT_AMOUNT);
    }

    function test_fork_aave_dai_deposit() public {
        _testDeposit("DAI", DEPOSIT_AMOUNT_18);
    }

    function test_fork_aave_eurc_deposit() public {
        _testDeposit("EURC", DEPOSIT_AMOUNT);
    }

    function test_fork_aave_usdbc_deposit() public {
        _testDeposit("USDbC", DEPOSIT_AMOUNT);
    }

    function test_fork_aave_gho_deposit() public {
        _testDeposit("GHO", DEPOSIT_AMOUNT_18);
    }

    function test_fork_aave_usds_deposit() public {
        _testDeposit("USDS", DEPOSIT_AMOUNT_18);
    }

    function test_fork_aave_weth_deposit() public {
        _testDeposit("WETH", 1 ether);
    }

    function test_fork_aave_cbbtc_deposit() public {
        _testDeposit("cbBTC", 0.01e8);
    }
