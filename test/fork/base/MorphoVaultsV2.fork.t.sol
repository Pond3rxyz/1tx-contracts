...
/// @title MorphoVaultsV2ForkTest
/// @notice Fork tests for the newly-added Morpho Vaults V2 USDC vaults on Base.
...
///
///      Pinned to a recent Base block because several of these vaults were deployed after the
///      block used by the shared {AdapterForkTestBase} (44_730_000).
///
...
///
///      Run: BASE_RPC_URL=... forge test --mc MorphoVaultsV2ForkTest -vv
contract MorphoVaultsV2ForkTest is Test {
    ...
    /// @dev Config keys (under baseMainnet.protocols.morpho.vaults) for the new V2 USDC vaults.
    string[] internal vaultKeys = [
        "clearstarCbAssetsUSDC",
        "gauntletUSDCFrontier",
        "yearnOGUSDCV2",
        "moonwellEcosystemUSDC",
        "steakhouseHighYieldUSDC",
        "farcasterSteakhousePrime",
        "rockawayXMidasUSDCPrime",
        "gauntletUSDCPrimeV2",
        "clearstarBoringUSDC",
        "architectGlobalValueII",
        "steakhousePrimeUSDCV2",
        "primeUSDC",
        "ethenaSteakhouseUSDC",
        "galaxyUSDCQuality",
        "architectGlobalValue",
        "moonwellFlagshipUSDC",
        "clearstarCoreUSDC",
        "avantgardeUSDCConservativeV2",
        "steakhouseHighYieldUSDCEdition"
    ];
    ...
    function test_fork_base_morphoV2_allVaults_depositWithdraw() public {
