...
/// @title EulerAdapterArbitrumForkTest
/// @notice Fork tests for EulerAdapter against Arbitrum mainnet
contract EulerAdapterArbitrumForkTest is AdapterForkTestBase {
    ...
    function test_fork_arbitrum_EulerEarn_eeUSDC_deposit() public {
        _testDeposit("USDC", "eeUSDC", DEPOSIT_AMOUNT);
    }

    function test_fork_arbitrum_EulerEarn_eeUSDC_depositWithdraw() public {
