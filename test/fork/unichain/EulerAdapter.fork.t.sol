...
/// @title EulerAdapterUnichainForkTest
/// @notice Fork tests for EulerAdapter against Unichain mainnet
contract EulerAdapterUnichainForkTest is AdapterForkTestBase {
    ...
    function test_fork_unichain_EulerEarn_eeUSDC_deposit() public {
        _testDeposit("USDC", "eeUSDC", DEPOSIT_AMOUNT);
    }

    function test_fork_unichain_EulerEarn_eeUSDC_depositWithdraw() public {
