...
contract MorphoAdapterTest is AdapterTestBase {
    ...
    function test_registerVault_revertsOnZeroVault() public {
        vm.prank(owner);
        vm.expectRevert(MorphoAdapter.InvalidVaultAddress.selector);
    ...
    function test_deposit_success() public {
        ...
        vm.expectEmit(true, false, false, true);
        emit DepositedToMorpho(vaultMarketId, DEPOSIT_AMOUNT, DEPOSIT_AMOUNT, recipient);
    ...
    function test_withdraw_success() public {
        ...
        vm.expectEmit(true, false, false, true);
        emit WithdrawnFromMorpho(vaultMarketId, DEPOSIT_AMOUNT, DEPOSIT_AMOUNT, recipient);
